...

{
 ...
 if ((((ptr)) != ((void *)0))) {} else {UnityFail( (" Expected Non-NULL"), (_U_UINT)(_U_UINT)(_U_UINT)14);;};

 if ((((ptr->Head)) == ((void *)0))) {} else {UnityFail( (" Expected NULL"), (_U_UINT)(_U_UINT)(_U_UINT)15);;};

 if ((((ptr->tail)) == ((void *)0))) {} else {UnityFail( (" Expected NULL"), (_U_UINT)(_U_UINT)(_U_UINT)16);;};
...

 {
  ...
  UnityAssertEqualNumber((_U_SINT)((9)), (_U_SINT)((newNode->value)), (((void *)0)), (_U_UINT)24, UNITY_DISPLAY_STYLE_INT);
